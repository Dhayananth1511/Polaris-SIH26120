...
# ── Paths ──────────────────────────────────────────────────────────────────────
_REPO_ROOT = Path(__file__).resolve().parents[3]          # Polaris-SIH26120/
...
class MLEngine:
    ...
    def ensure_ready(self) -> None:
        ...
        try:
            ...
            self._ready = True
            logger.info("ml_engine: all models ready ✓")
    ...
    def _train_anomaly_model(self) -> None:
        ...
        logger.info("IsolationForest trained on %d telemetry rows ✓", len(X))
    ...
    def _build_failure_priors(self) -> None:
        ...
        # Use simple MOM estimation: α/(α+β) = failure_rate
